...
public class OptionsMenuItemHandler extends BaseAnnotationHandler<HasOptionsMenu>implements HasMethodInjection<HasOptionsMenu> {
	...
	@Override
	public IJExpression getInstanceInvocation(Element element, HasOptionsMenu holder, Element param) {
		...
		return menuParam.invoke("findItem").arg(idsRef);
	}
}
