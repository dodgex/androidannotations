...
public class InjectMenuHandler extends BaseAnnotationHandler<HasOptionsMenu>implements HasMethodInjection<HasOptionsMenu> {
	...
	public IJExpression getInstanceInvocation(Element element, HasOptionsMenu holder, Element param) {
		return holder.getOnCreateOptionsMenuMenuParam();
	}
}
