...
public class RestServiceHandler extends BaseAnnotationHandler<EComponentHolder>implements HasMethodInjection<EComponentHolder> {
	...
	public IJExpression getInstanceInvocation(Element element, EComponentHolder holder, Element param) {
		...
		return JExpr._new(clazz).arg(holder.getContextRef());
	}
}
